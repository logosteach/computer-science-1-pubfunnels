...
Open the **Python Shell** (the window that says >>>).  
...
**A – Simple Praise Banner** (type each line separately)  
```python
>>> print("✝" * 25)
>>> print("  PRAISE THE LORD  " * 2)
>>> print("✝" * 25)
```

**B – Countdown to Praise**  
```python
>>> print(3, end="... ")
>>> print(2, end="... ")
>>> print(1, end="... ")
...
**C – Be Still Box** (type line by line)  
```python
>>> print("+" * 20)
>>> print("+  Be still, and know  " + "+")
>>> print("+  that I am God      " + "+")
>>> print("+" * 20)
```
...
- Did I use end= at least once?  
- Did I use + to join strings?  
- Did I use * to repeat something?  
