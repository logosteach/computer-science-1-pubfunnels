...
root_dir = Path(__file__).parent.parent.parent  # Goes up to root_folder
...
if times_run == 0:
    lesson_title = "Python Code Lesson Template"
    description = (
        "This is a template for Python code lessons. Fill in the lesson content below."
    )
